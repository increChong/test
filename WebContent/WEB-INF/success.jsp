					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td style="padding: 20px; text-align: center"><table
									width="70%" border="0" cellspacing="0" style="margin-top: 70px">
									<tr>
										<td style="width: 98"><img src="images/success.gif"
											width="98" height="119" /></td>
										<td style="padding-top: 30px"><font
											style="font-weight: bold; color: #FF0000">您的用户信息修改成功！</font><br />
											<br /> <a href="my.html">返回我的帐户</a></td>
									</tr>
								</table>
								<p>&nbsp;</p></td>
						</tr>
