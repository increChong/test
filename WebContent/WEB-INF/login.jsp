								...
								<tr>
														...
														<td style="text-align: center"><table width="80%"
																...
																<tr>
																	...
																	<td style="text-align: left"><input
																		name="uloginid" type="text" class="textinput" /></td>
																</tr>
																<tr>
																...
																<tr>
																	<td colspan="2"
																		...
																		name="image" type="image" src="images/loginbutton.gif"
																...
																<tr>
																	<td colspan="2"
																		...
																		href="${pageContext.request.contextPath}/dispatcher.do?type=teg"><input
																			name="image" type="image"
																			src="images/signupbutton.gif" width="135" height="33" /></a></td>
																</tr>
															</table></td>
													</tr>
												</table>
									...
									<td style="text-align: left; padding-top: 30px; width: 60%"><h1>您还没有注册？</h1>
										...
										<p style="text-align: right">
											<a
												href="${pageContext.request.contextPath}/dispatcher.do?type=teg">
